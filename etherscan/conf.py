...
DEFAULTS = {
    ...
    'EVENT_SCAN_COST_THR': int(os.environ.get("IZUMI_INFRA_ETHERSCAN.EVENT_SCAN_COST_THR", 3)),
    'ADMIN_PAGE_FAKE_COUNT': os.environ.get("IZUMI_INFRA_ETHERSCAN.ADMIN_PAGE_FAKE_COUNT", "True") == 'True',
    'EVENT_SCAN_ENABLE_ASYNC_SIGNAL': os.environ.get("IZUMI_INFRA_ETHERSCAN.EVENT_SCAN_ENABLE_ASYNC_SIGNAL", "False") == 'True',
    'EVENT_ADMIN_INLINES_CLASS': None,
    'EVENT_ADMIN_OUTER_LINK_FUNC': None,
    'EVENT_FILTER_FUNCTION_LIST': None,
    'EVENT_SCAN_FALLBACK_FUNCTION_LIST': None,
...
IMPORT_STRINGS = {
    ...
    'EVENT_ADMIN_OUTER_LINK_FUNC',
    'EVENT_FILTER_FUNCTION_LIST',
    'EVENT_SCAN_FALLBACK_FUNCTION_LIST',
}
